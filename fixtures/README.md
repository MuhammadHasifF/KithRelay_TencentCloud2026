...
`mdm-tan` is a deliberately fictional dataset for the CareCircle Copilot demo. It contains one rescheduled appointment, one medication-strength change, one discontinuation, one newly listed medicine, and one payment deadline.
