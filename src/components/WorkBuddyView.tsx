...
export function WorkBuddyView({
  ...
  const heroDescription = permissionNeeded
    ...
    : connected
      ...
      : 'Choose the folder containing the care documents. KithRelay remembers the folder where supported and writes the task into it for you.'
  ...
  return (
    <div className="view-stack">
      ...
      <div className="agent-note"><Bot size={18} /><p><strong>Connection boundary:</strong> KithRelay uses browser permission to a single authorized folder, writes the task into it, and checks it while this page is open. WorkBuddy still runs as the desktop agent and follows its own cloud-processing and privacy settings.</p></div>
    </div>
  )
}
