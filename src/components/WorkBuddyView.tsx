  ...
  return (
    <div className="view-stack">
      ...
      <section className="agent-relationship">
        <div className="relationship-node"><CodeXml size={22} /><strong>KithRelay repository</strong><span>App, skill, fixtures, tests</span></div>
      ...
      <section className="workbuddy-grid">
        <article className="panel setup-card">
          <p className="overline">One-time setup</p><h3>Install the KithRelay skill</h3>
          ...
          <a className="primary-button full" href="./downloads/kithrelay-workbuddy.zip" download><Download size={17} /> Download WorkBuddy skill</a>
        </article>
